// ADUGAME remaining commercial-art v1.05 polish.
...
(() => {
  ...
  const CFG={
    G1R1:{wash:'linear-gradient(180deg,rgba(231,246,250,.025),rgba(249,250,246,.015) 60%,rgba(217,229,224,.025) 60.2% 100%)',hero:{x:1030,y:365,w:300},bgOpacity:'.16'},
    ...
    G2R3:{wash:'linear-gradient(180deg,rgba(235,242,247,.055),rgba(248,244,232,.035) 58%,rgba(194,177,151,.055) 58.2% 100%)',hero:{x:1055,y:382,w:172}}
  };
  ...
  function apply(scene){
    ...
    if(root.dataset.v105Polished==='1')return;
    root.dataset.v105Polished='1';root.dataset.version='1.05';root.dataset.interactionPriority='live-phaser-hit-targets';root.dataset.generatedVisualAssets='0';
    ...
    if(key==='G1R1'&&hero)hero.style.filter='saturate(1.12) contrast(1.075) drop-shadow(0 11px 16px rgba(48,56,82,.13))';
    ...
    if(window.__ADUGAME_ART_SOURCE__?.REMAINING){
      window.__ADUGAME_ART_SOURCE__.REMAINING.version='commercial-v1.05';
  ...
  window.__ADUGAME_REMAINING_COMMERCIAL_ART_POLISH__={loaded:true,version:'1.05',liveInteractionPriority:true,generatedVisualAssets:0,authoredToyCar:TOY_CAR};
})();