// ADUGAME remaining commercial-art v1.06 polish.
...
(() => {
  ...
  function apply(scene){
    ...
    if(root.dataset.v106Polished==='1')return;
    root.dataset.v106Polished='1';root.dataset.version='1.06';root.dataset.interactionPriority='live-phaser-hit-targets';root.dataset.generatedVisualAssets='0';
    ...
    if(window.__ADUGAME_ART_SOURCE__?.REMAINING){
      window.__ADUGAME_ART_SOURCE__.REMAINING.version='commercial-v1.06';
  ...
  window.__ADUGAME_REMAINING_COMMERCIAL_ART_POLISH__={loaded:true,version:'1.06',liveInteractionPriority:true,generatedVisualAssets:0,authoredToyCar:TOY_CAR,g1r1DuplicateBathroomRemoved:true};
})();