...
test('R2 v17.7 toothpaste-brush-facewash chain',async({page})=>{
...
test('R2 v17.7 nail clipper input 5 of 5',async({page})=>{
...
test('R2 v17.7 initial frame beside Baby Panda benchmark',async({page})=>{
