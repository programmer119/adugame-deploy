...
test('actual G1R2 v17.1 + benchmark side-by-side',async({page})=>{
  ...
  expect(version).toBe('v17.1');
  const current=await page.screenshot({path:'qa/reports/g1r2-fast/G1R2-v17.1.png',fullPage:true});
  ...
  </style></head><body><div class="w"><div class="s"><div class="l">BABY PANDA · ACTION COMPOSITION</div><img id="o" src="${OFFICIAL}"></div><div class="s"><div class="l">ADUGAME · ACTUAL R2 v17.1</div><img src="${data}"></div></div></body></html>`,{waitUntil:'domcontentloaded'});
