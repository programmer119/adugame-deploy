...
test('R2 v17.5 toothpaste-brush-facewash chain',async({page})=>{
  ...
  await drag(page,[[1110,420],[790,330],[735,330],[845,330],[735,345],[845,345],[735,315],[845,315],[790,330]],1);await waitStep(page,3);await snap(page,'STEP-3-nails');const d=await debug(page,'DEBUG-chain-done');
  expect(d.state.faceWash).toBeGreaterThanOrEqual(360);expect(d.state.g1r2V17Input.pasteDown).toBe(1);expect(d.state.g1r2V17Input.brushMove).toBeGreaterThan(0);expect(d.state.g1r2V17Input.clothMove).toBeGreaterThan(0);
});
