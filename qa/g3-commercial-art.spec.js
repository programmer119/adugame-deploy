...
test('G3 authored commercial art stays aligned through first customer and shop reveal',async({page})=>{
  ...
  await waitDebug(page,()=>{const r=document.getElementById('g3-commercial-art-v1');return r&&r.dataset.ready==='1'&&r.dataset.hitAlignment==='1'&&r.dataset.v2HeroReady==='1'&&r.dataset.version==='2.1';},null,30000);
  ...
  // Use the live rendered Phaser text bounds, identical to the stable full-cycle G3 gate.
