...
(() => {
  ...
  // Use Phaser's own size-aware rectangular hit geometry for Containers instead of
  // hand-authored negative-coordinate rectangles, which behaved inconsistently in Chromium.
  ...
  // 3) G1R3: dedicated faucet and continuous hand sampling.
  ...
  // 4) G2R2: keep item hit surfaces generated by dragify, but stop the washer
  ...
  // 7) Explicit color tap surfaces using Zone defaults.
